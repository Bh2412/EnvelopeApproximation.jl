...
export fourier_modes, ChebyshevPlan, First3MomentsChebyshevPlan, VectorChebyshevPlan, TailoredChebyshevPlan,
       TailoredVectorChebyshevPlan, ChebyshevPlanWithAtol, VectorChebyshevPlanWithAtol, TailoredVectorChebyshevPlanWithAtol
...
mutable struct ChebyshevPlan{N} <: CFTPlan
...
mutable struct First3MomentsChebyshevPlan{N} <: CFTPlan
    points::Vector{Float64}
...
mutable struct VectorChebyshevPlan{N,K} <: CFTPlan
    points::Vector{Float64}
...
mutable struct TailoredChebyshevPlan{N} <: CFTPlan
    points::Vector{Float64}
    coeffs_buffer::Vector{Float64}
...
mutable struct TailoredVectorChebyshevPlan{N,K} <: CFTPlan
    points::Vector{Float64}
    coeffs_buffer::Matrix{Float64}
    weights::Matrix{ComplexF64}
    transform_plan!::FastTransforms.ChebyshevTransformPlan{Float64,1,Vector{Int32},true,2,Int64}
...
mutable struct ChebyshevPlanWithAtol{N,P} <: CFTPlan
    points::Vector{Float64}
    coeffs_buffer::Vector{Float64}
...
mutable struct VectorChebyshevPlanWithAtol{N,K,P} <: CFTPlan
    points::Vector{Float64}
    coeffs_buffer::Matrix{Float64}
...
mutable struct TailoredVectorChebyshevPlanWithAtol{N,K,P} <: CFTPlan
    points::Vector{Float64}
    coeffs_buffer::Matrix{Float64}
    lower_order_coeffs_buffer::Matrix{Float64}
    weights::Matrix{ComplexF64}
